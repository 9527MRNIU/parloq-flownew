  ...
  return (
    ...
    >
      <SheetContent
        className={
          wide
            ? "gap-0 data-[side=right]:w-full data-[side=right]:sm:max-w-[var(--drawer-size-wide)]"
            : "gap-0 data-[side=right]:w-full data-[side=right]:sm:max-w-[var(--drawer-size-default)]"
        }
      >
        <SheetHeader>
