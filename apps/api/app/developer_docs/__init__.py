    ...
    },
    {
        ...
        "pages": (
            ...
            },
            {
                "slug": "menu-protocols",
                "title": "协议管理",
                "summary": "维护协议实现仓库、版本和构建状态。",
                "menuPath": "资源 / 运营管理 / 协议中心 / 协议管理",
                "routePath": "/resources/operations/protocol-center?tab=protocols",
                "keywords": ("协议", "实现仓库", "版本", "构建"),
            },
            {
                "slug": "menu-protocol-nodes",
                "title": "节点管理",
                "summary": "维护协议节点、容量开关、连接策略和同步范围。",
                "menuPath": "资源 / 运营管理 / 协议中心 / 节点管理",
                "routePath": "/resources/operations/protocol-center?tab=nodes",
                "keywords": ("协议节点", "容量", "连接", "配对"),
            },
            {
                "slug": "menu-protocol-routing",
                "title": "路由策略",
                "summary": "维护渠道使用的协议池和节点回退顺序。",
                "menuPath": "资源 / 运营管理 / 协议中心 / 路由策略",
                "routePath": "/resources/operations/protocol-center?tab=routing",
                "keywords": ("协议池", "路由", "回退", "优先级"),
            },
            {
                "slug": "menu-ip-management",
                "title": "代理管理",
                "summary": "维护代理资源、健康状态、账号绑定和分配策略。",
                "menuPath": "资源 / 运营管理 / 代理管理",
