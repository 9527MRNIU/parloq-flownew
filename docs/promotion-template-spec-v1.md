...
- 未经产品确认，不得加入第三方统计、隐藏 iframe、指纹采集或外部脚本。
...
模板作者不得额外引入 DevTools 检测、无限 `debugger`、清空控制台、强制跳转空白页等代码。这些做法有误杀、性能和可维护性风险，也无法真正隐藏已发送到浏览器的代码。

真正的安全规则是：密钥、协议凭据、渠道鉴权逻辑和租户数据永远不下发到模板。

## 10. 禁止事项

- 外部 JavaScript、未知第三方 SDK、隐藏 iframe 或跨域数据回传；
